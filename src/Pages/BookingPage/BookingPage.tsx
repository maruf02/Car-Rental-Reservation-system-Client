...
import BookingSingleViewPage from "../BookingSingleViewPage/BookingSingleViewPage";
...
const BookingPage = () => {
  ...
  if (productsData && products.length === 0) {
    const availableCars = productsData.data.filter(
      (product: Product) => product.status === "available"
    );
    setProducts(availableCars);
    setDisplayedProducts(availableCars);
  }
      ...
      >
        ...
        <div className="hero-content text-neutral-content text-center">
          <div className="max-w-lg">
            <h1 className="mb-5 pt text-3xl font-bold text-white">
