const WhyChooseUsSection = () => {
  return (
    <div className="py-10">
      <div className="pb-10">
        <p className="text-center text-base font-semibold leading-7 text-[#5B99C2]">
          Why Choose Us
        </p>
        <h2 className="text-center font-display text-3xl font-bold tracking-tight text-[#5B99C2] md:text-4xl">
